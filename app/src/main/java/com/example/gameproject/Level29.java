...
public class Level29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level29);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level28);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level30);
        ...
        textdescriptionend.setText(R.string.leveltwentynineend);
