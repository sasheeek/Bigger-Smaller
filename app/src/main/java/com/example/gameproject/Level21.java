...
public class Level21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level21);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level20);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level22);
        ...
        numLeft = random.nextInt(23);
        img_left.setImageResource(array.images21[numLeft]);

        numRight = random.nextInt(23);
