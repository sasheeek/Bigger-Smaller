...
public class Level23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level23);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level22);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level24);
