...
public class Level26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level26);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level25);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level27);
