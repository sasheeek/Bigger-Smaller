...
public class Level27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level27);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level26);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level28);
