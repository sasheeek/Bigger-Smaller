...
public class Level30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level30);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level29);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level31);
        ...
        numLeft = random.nextInt(27);
        img_left.setImageResource(array.images30[numLeft]);

        numRight = random.nextInt(27);
