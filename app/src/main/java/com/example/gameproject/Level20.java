...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level20);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level19);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level21);
