...
public class Level18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level18);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level17);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level19);
        ...
        numLeft = random.nextInt(40);
        img_left.setImageResource(array.images18[numLeft]);

        numRight = random.nextInt(40);
