...
public class Level24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level24);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level23);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level25);
        ...
        numLeft = random.nextInt(29);
        img_left.setImageResource(array.images24[numLeft]);

        numRight = random.nextInt(29);
