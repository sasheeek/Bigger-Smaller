...
public class Level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.background_level15);
        ...
        dialogfon1.setBackgroundResource(R.drawable.background_level14);
        ...
        dialogfon2.setBackgroundResource(R.drawable.background_level16);
